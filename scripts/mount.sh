...
export SPEL_AMIGENREPOS="${SPEL_AMIGENREPOS:-spel,packages-microsoft-com-prod,rhel-9-for-x86_64-baseos-rhui-rpms,rhel-9-for-x86_64-supplementary-rhui-rpms,rhui-microsoft-azure-rhel9}"
