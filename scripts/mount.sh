...
export SPEL_AMIGENREPOS="rhel-9-for-x86_64-appstream-rhui-rpms,rhel-9-for-x86_64-baseos-rhui-rpms,rhel-9-for-x86_64-supplementary-rhui-rpms,rhui-microsoft-azure-rhel9"
...
export SPEL_EXTRARPMS="crypto-policies-scripts,spel-release,spel-dod-certs,spel-wcf-certs"
