...
export SPEL_AMIGENBUILDDEV="/dev/sda"
export SPEL_AMIGENCHROOT="/mnt/ec2-root"
export SPEL_AMIGENPKGGRP="core"
export SPEL_AMIGENREPOS="spel"
...
export SPEL_EXTRARPMS="crypto-policies-scripts,spel-release,spel-dod-certs,spel-wcf-certs,ec2-hibinit-agent,ec2-utils,https://s3.amazonaws.com/ec2-downloads-windows/SSMAgent/latest/linux_amd64/amazon-ssm-agent.rpm"
