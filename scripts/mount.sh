...
export SPEL_AMIGENREPOS="packages-microsoft-com-prod,rhel-9-for-x86_64-appstream-rhui-rpms,rhel-9-for-x86_64-baseos-rhui-rpms,rhel-9-for-x86_64-supplementary-rhui-rpms,rhui-microsoft-azure-rhel9"
...
export SPEL_EXTRARPMS="WALinuxAgent"
